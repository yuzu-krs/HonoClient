...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.OAK_DOOR, p_358245_ -> this.createDoorTable(p_358245_));
        this.add(Blocks.SPRUCE_DOOR, p_358239_ -> this.createDoorTable(p_358239_));
        this.add(Blocks.BIRCH_DOOR, p_358278_ -> this.createDoorTable(p_358278_));
        this.add(Blocks.JUNGLE_DOOR, p_358308_ -> this.createDoorTable(p_358308_));
        this.add(Blocks.ACACIA_DOOR, p_358276_ -> this.createDoorTable(p_358276_));
        this.add(Blocks.DARK_OAK_DOOR, p_358231_ -> this.createDoorTable(p_358231_));
        this.add(Blocks.PALE_OAK_DOOR, noDrop());
        this.add(Blocks.MANGROVE_DOOR, p_358243_ -> this.createDoorTable(p_358243_));
        this.add(Blocks.CHERRY_DOOR, p_358266_ -> this.createDoorTable(p_358266_));
        this.add(Blocks.BAMBOO_DOOR, p_358241_ -> this.createDoorTable(p_358241_));
        this.add(Blocks.WARPED_DOOR, p_358290_ -> this.createDoorTable(p_358290_));
        this.add(Blocks.CRIMSON_DOOR, p_358268_ -> this.createDoorTable(p_358268_));
        this.add(Blocks.IRON_DOOR, p_358294_ -> this.createDoorTable(p_358294_));
        this.add(Blocks.COPPER_DOOR, p_358260_ -> this.createDoorTable(p_358260_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_358303_ -> this.createDoorTable(p_358303_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_358247_ -> this.createDoorTable(p_358247_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_358249_ -> this.createDoorTable(p_358249_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_358272_ -> this.createDoorTable(p_358272_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_358225_ -> this.createDoorTable(p_358225_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_358282_ -> this.createDoorTable(p_358282_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_358274_ -> this.createDoorTable(p_358274_));
        ...
        this.add(Blocks.CANDLE, p_358255_ -> this.createCandleDrops(p_358255_));
        this.add(Blocks.WHITE_CANDLE, p_358280_ -> this.createCandleDrops(p_358280_));
        this.add(Blocks.ORANGE_CANDLE, p_358299_ -> this.createCandleDrops(p_358299_));
        this.add(Blocks.MAGENTA_CANDLE, p_358286_ -> this.createCandleDrops(p_358286_));
        this.add(Blocks.LIGHT_BLUE_CANDLE, p_358229_ -> this.createCandleDrops(p_358229_));
        this.add(Blocks.YELLOW_CANDLE, p_358301_ -> this.createCandleDrops(p_358301_));
        this.add(Blocks.LIME_CANDLE, p_358284_ -> this.createCandleDrops(p_358284_));
        this.add(Blocks.PINK_CANDLE, p_358270_ -> this.createCandleDrops(p_358270_));
        this.add(Blocks.GRAY_CANDLE, p_358227_ -> this.createCandleDrops(p_358227_));
        this.add(Blocks.LIGHT_GRAY_CANDLE, p_358306_ -> this.createCandleDrops(p_358306_));
        this.add(Blocks.CYAN_CANDLE, p_358312_ -> this.createCandleDrops(p_358312_));
        this.add(Blocks.PURPLE_CANDLE, p_358235_ -> this.createCandleDrops(p_358235_));
        this.add(Blocks.BLUE_CANDLE, p_358292_ -> this.createCandleDrops(p_358292_));
        this.add(Blocks.BROWN_CANDLE, p_358251_ -> this.createCandleDrops(p_358251_));
        this.add(Blocks.GREEN_CANDLE, p_358262_ -> this.createCandleDrops(p_358262_));
        this.add(Blocks.RED_CANDLE, p_358310_ -> this.createCandleDrops(p_358310_));
        this.add(Blocks.BLACK_CANDLE, p_358223_ -> this.createCandleDrops(p_358223_));
        ...
        this.add(Blocks.MANGROVE_LEAVES, p_358253_ -> this.createMangroveLeavesDrops(p_358253_));
