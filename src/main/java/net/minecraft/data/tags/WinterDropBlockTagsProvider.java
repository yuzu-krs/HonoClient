...
public class WinterDropBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    public WinterDropBlockTagsProvider(
        PackOutput p_370161_, CompletableFuture<HolderLookup.Provider> p_366134_, CompletableFuture<TagsProvider.TagLookup<Block>> p_367496_
    ) {
        super(p_370161_, Registries.BLOCK, p_366134_, p_367496_, p_366000_ -> p_366000_.builtInRegistryHolder().key());
    }

    @Override
    protected void addTags(HolderLookup.Provider p_364061_) {
