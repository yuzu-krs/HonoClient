...
public class BlockModelGenerators {
    ...
    public static final List<Pair<Direction, Function<ResourceLocation, Variant>>> MULTIFACE_GENERATOR = List.of(
        Pair.of(Direction.NORTH, p_176234_ -> Variant.variant().with(VariantProperties.MODEL, p_176234_)),
        Pair.of(
            Direction.EAST,
    ...
    private void createCreakingHeart(Block p_361786_) {
        Function<TexturedModel.Provider, ResourceLocation> function = p_358330_ -> p_358330_.updateTexture(
                    p_358332_ -> p_358332_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(p_361786_, "_active"))
                )
                .updateTexture(p_358324_ -> p_358324_.put(TextureSlot.END, TextureMapping.getBlockTexture(p_361786_, "_top_active")))
                .createWithSuffix(p_361786_, "_active", this.modelOutput);
        ResourceLocation resourcelocation = TexturedModel.COLUMN_ALT.create(p_361786_, this.modelOutput);
        ResourceLocation resourcelocation1 = TexturedModel.COLUMN_HORIZONTAL_ALT.create(p_361786_, this.modelOutput);
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(p_361786_)
                    .with(
    ...
    private void createBeeNest(Block p_124584_, Function<Block, TextureMapping> p_124585_) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.CUBE_ORIENTABLE_TOP_BOTTOM.createWithSuffix(p_124584_, "_empty", texturemapping, this.modelOutput);
        ...
        this.skipAutoItemBlock(p_124584_);
        ModelTemplates.CUBE_ORIENTABLE_TOP_BOTTOM.create(ModelLocationUtils.getModelLocation(p_124584_.asItem(), "_empty"), texturemapping, this.modelOutput);
        ModelTemplates.CUBE_ORIENTABLE_TOP_BOTTOM.create(ModelLocationUtils.getModelLocation(p_124584_.asItem(), "_honey"), texturemapping1, this.modelOutput);
        this.blockStateOutput
            .accept(
    ...
    private void createMultiface(Block p_176086_) {
        ...
        Condition.TerminalCondition condition$terminalcondition = Util.make(
            Condition.condition(), p_358326_ -> MULTIFACE_GENERATOR.stream().map(Pair::getFirst).map(MultifaceBlock::getFaceProperty).forEach(p_236299_ -> {
                    if (p_176086_.defaultBlockState().hasProperty(p_236299_)) {
                        p_358326_.term(p_236299_, false);
                    }
                })
        );
    ...
    private void createMossyCarpet(Block p_365502_) {
        ResourceLocation resourcelocation = TexturedModel.CARPET.create(p_365502_, this.modelOutput);
        ResourceLocation resourcelocation1 = TexturedModel.MOSSY_CARPET_SIDE
            .get(p_365502_)
            .updateTextures(p_358328_ -> p_358328_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(p_365502_, "_side_tall")))
            .createWithSuffix(p_365502_, "_side_tall", this.modelOutput);
        ResourceLocation resourcelocation2 = TexturedModel.MOSSY_CARPET_SIDE
            .get(p_365502_)
            .updateTextures(p_358319_ -> p_358319_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(p_365502_, "_side_small")))
            .createWithSuffix(p_365502_, "_side_small", this.modelOutput);
        MultiPartGenerator multipartgenerator = MultiPartGenerator.multiPart(p_365502_);
        ...
        MULTIFACE_GENERATOR.stream().map(Pair::getFirst).forEach(p_358322_ -> {
            EnumProperty<WallSide> enumproperty1 = MossyCarpetBlock.getPropertyForFace(p_358322_);
            if (enumproperty1 != null && p_365502_.defaultBlockState().hasProperty(enumproperty1)) {
    ...
    private void createHangingMoss(Block p_369684_) {
        PropertyDispatch propertydispatch = PropertyDispatch.property(HangingMossBlock.TIP).generate(p_358314_ -> {
            String s = p_358314_ ? "_tip" : "";
            TextureMapping texturemapping = TextureMapping.cross(TextureMapping.getBlockTexture(p_369684_, s));
            ResourceLocation resourcelocation = BlockModelGenerators.TintState.NOT_TINTED.getCross().createWithSuffix(p_369684_, s, texturemapping, this.modelOutput);
            return Variant.variant().with(VariantProperties.MODEL, resourcelocation);
        });
        this.createSimpleFlatItemModel(p_369684_);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(p_369684_).with(propertydispatch));
    }
    ...
    private void createChiseledBookshelf() {
        ...
        List.of(
            ...
            .forEach(
                p_358317_ -> {
                    Direction direction = p_358317_.getFirst();
                    VariantProperties.Rotation variantproperties$rotation = p_358317_.getSecond();
