    ...
    public static class C2<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(BiFunction<T1, T2, Variant> p_125363_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358340_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176322_ -> this.select((T1)p_358340_, (T2)p_176322_, p_125363_.apply((T1)p_358340_, (T2)p_176322_)))
                );
            return this;
        }
        ...
        public PropertyDispatch generateList(BiFunction<T1, T2, List<Variant>> p_125373_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358342_ -> this.property2
                            .getPossibleValues()
                            .forEach(p_176318_ -> this.select((T1)p_358342_, (T2)p_176318_, p_125373_.apply((T1)p_358342_, (T2)p_176318_)))
                );
            return this;
        }
    }
    ...
    public static class C3<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(PropertyDispatch.TriFunction<T1, T2, T3, Variant> p_125390_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358347_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358345_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_176339_ -> this.select(
                                                    ...
                                                    (T2)p_358345_,
                                                    (T3)p_176339_,
                                                    p_125390_.apply((T1)p_358347_, (T2)p_358345_, (T3)p_176339_)
                                                )
                                        )
                            )
                );
        ...
        public PropertyDispatch generateList(PropertyDispatch.TriFunction<T1, T2, T3, List<Variant>> p_176345_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358352_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358350_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_176327_ -> this.select(
                                                    ...
                                                    (T2)p_358350_,
                                                    (T3)p_176327_,
                                                    p_176345_.apply((T1)p_358352_, (T2)p_358350_, (T3)p_176327_)
                                                )
                                        )
                            )
                );
    ...
    public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(PropertyDispatch.QuadFunction<T1, T2, T3, T4, Variant> p_176362_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358357_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358360_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_358368_ -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        p_176371_ -> this.select(
                                                                ...
                                                                (T3)p_358368_,
                                                                (T4)p_176371_,
                                                                p_176362_.apply((T1)p_358357_, (T2)p_358360_, (T3)p_358368_, (T4)p_176371_)
                                                            )
                                                    )
                                        )
                            )
        ...
        public PropertyDispatch generateList(PropertyDispatch.QuadFunction<T1, T2, T3, T4, List<Variant>> p_176382_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358370_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358355_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_358364_ -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        p_176351_ -> this.select(
                                                                ...
                                                                (T3)p_358364_,
                                                                (T4)p_176351_,
                                                                p_176382_.apply((T1)p_358370_, (T2)p_358355_, (T3)p_358364_, (T4)p_176351_)
                                                            )
                                                    )
                                        )
                            )
    ...
    public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
        ...
        public PropertyDispatch generate(PropertyDispatch.PentaFunction<T1, T2, T3, T4, T5, Variant> p_176409_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358389_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358373_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_358387_ -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        p_358380_ -> this.property5
                                                                .getPossibleValues()
                                                                .forEach(
                                                                    p_176419_ -> this.select(
                                                                            ...
                                                                            (T5)p_176419_,
                                                                            p_176409_.apply(
                                                                                (T1)p_358389_, (T2)p_358373_, (T3)p_358387_, (T4)p_358380_, (T5)p_176419_
                                                                            )
                                                                        )
                                                                )
                                                    )
        ...
        public PropertyDispatch generateList(PropertyDispatch.PentaFunction<T1, T2, T3, T4, T5, List<Variant>> p_176436_) {
            this.property1
                .getPossibleValues()
                .forEach(
                    p_358375_ -> this.property2
                            .getPossibleValues()
                            .forEach(
                                p_358383_ -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            p_358398_ -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        p_358394_ -> this.property5
                                                                .getPossibleValues()
                                                                .forEach(
                                                                    p_176392_ -> this.select(
                                                                            ...
                                                                            (T5)p_176392_,
                                                                            p_176436_.apply(
                                                                                (T1)p_358375_, (T2)p_358383_, (T3)p_358398_, (T4)p_358394_, (T5)p_176392_
                                                                            )
                                                                        )
                                                                )
                                                    )
