...
public class BlockModel implements UnbakedModel {
    ...
    public void resolveDependencies(UnbakedModel.Resolver p_365651_) {
        if (this.parentLocation != null) {
            if (!(p_365651_.resolve(this.parentLocation) instanceof BlockModel blockmodel)) {
    ...
    private static BakedQuad bakeFace(
        ...
        return FACE_BAKERY.bakeQuad(
            p_111438_.from, p_111438_.to, p_111439_, p_111440_, p_111441_, p_111442_, p_111438_.rotation, p_111438_.shade, p_111438_.lightEmission
        );
    }
