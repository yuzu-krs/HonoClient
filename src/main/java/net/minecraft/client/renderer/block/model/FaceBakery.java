...
public class FaceBakery {
    ...
    public BakedQuad bakeQuad(
        ...
        int[] aint = this.makeVertices(blockfaceuv, p_111604_, p_111605_, this.setupShape(p_253895_, p_253976_), p_111606_.getRotation(), p_111607_);
    ...
    private int[] makeVertices(
        ...
        for (int i = 0; i < 4; i++) {
            this.bakeVertex(aint, i, p_111576_, p_111574_, p_111577_, p_111575_, p_111578_, p_111579_);
        }
