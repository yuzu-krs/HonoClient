...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
    ...
    public EntityRenderDispatcher(
        ...
        this.equipmentModels = p_362020_;
    }
        ...
        try {
            ...
            if (this.options.entityShadows().get() && this.shouldRenderShadow && !s.isInvisible) {
                ...
                if (f > 0.0F) {
                    ...
                    float f1 = (float)((1.0 - d2 / 256.0) * (double)p_367105_.shadowStrength);
                    if (f1 > 0.0F) {
    ...
    public void onResourceManagerReload(ResourceManager p_174004_) {
        EntityRendererProvider.Context entityrendererprovider$context = new EntityRendererProvider.Context(
            this, this.itemRenderer, this.mapRenderer, this.blockRenderDispatcher, p_174004_, this.entityModels, this.equipmentModels, this.font
        );
