...
public class ItemEntityRenderer extends EntityRenderer<ItemEntity, ItemEntityRenderState> {
    ...
    public void extractRenderState(ItemEntity p_365788_, ItemEntityRenderState p_361751_, float p_369533_) {
        ...
        ItemStack itemstack = p_365788_.getItem();
        p_361751_.item = itemstack.copy();
        p_361751_.itemModel = this.itemRenderer.getModel(itemstack, p_365788_.level(), null, p_365788_.getId());
    }

    public void render(ItemEntityRenderState p_365095_, PoseStack p_115030_, MultiBufferSource p_115031_, int p_115032_) {
        BakedModel bakedmodel = p_365095_.itemModel;
        if (bakedmodel != null) {
            p_115030_.pushPose();
            ItemStack itemstack = p_365095_.item;
            ...
            renderMultipleFromCount(this.itemRenderer, p_115030_, p_115031_, p_115032_, itemstack, bakedmodel, flag, this.random);
            p_115030_.popPose();
