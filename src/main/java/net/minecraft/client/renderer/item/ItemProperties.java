...
public class ItemProperties {
    ...
    private static int honeyLevelProperty(ItemStack p_364208_) {
        BlockItemStateProperties blockitemstateproperties = p_364208_.getOrDefault(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY);
    ...
    static {
        ...
        registerGeneric(
            ...
            (p_358014_, p_358015_, p_358016_, p_358017_) -> p_358016_ instanceof Player ? ((Player)p_358016_).getCooldowns().getCooldownPercent(p_358014_, 0.0F) : 0.0F
        );
        ClampedItemPropertyFunction clampeditempropertyfunction = (p_358006_, p_358007_, p_358008_, p_358009_) -> {
            ArmorTrim armortrim = p_358006_.get(DataComponents.TRIM);
        ...
        registerGeneric(ResourceLocation.withDefaultNamespace("broken"), (p_358018_, p_358019_, p_358020_, p_358021_) -> p_358018_.nextDamageWillBreak() ? 1.0F : 0.0F);
        ...
        for (BundleItem bundleitem : BundleItem.getAllBundleItemColors()) {
            register(
                bundleitem.asItem(), ResourceLocation.withDefaultNamespace("filled"), (p_174625_, p_174626_, p_174627_, p_174628_) -> BundleItem.getFullnessDisplay(p_174625_)
            );
        }
        ...
        register(Items.BEE_NEST, ResourceLocation.withDefaultNamespace("honey_level"), (p_358022_, p_358023_, p_358024_, p_358025_) -> (float)honeyLevelProperty(p_358022_));
        register(Items.BEEHIVE, ResourceLocation.withDefaultNamespace("honey_level"), (p_358010_, p_358011_, p_358012_, p_358013_) -> (float)honeyLevelProperty(p_358010_));
    }
}