            ...
            .forEach(
                p_357966_ -> {
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::attackTarget)
                        .map(p_357959_ -> localplayer.level().getEntity(p_357959_))
                        .map(p_357967_ -> p_357967_.getPosition(this.minecraft.getDeltaTracker().getGameTimeDeltaPartialTick(true)))
                        .ifPresent(
                            p_310972_ -> {
                                drawLine(p_311387_, p_310722_, p_312623_, p_310151_, p_312438_, p_357966_.position(), p_310972_, TARGET_LINE_COLOR);
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::jumpTarget)
                        .ifPresent(
                            p_357957_ -> {
                                drawLine(p_311387_, p_310722_, p_312623_, p_310151_, p_312438_, p_357966_.position(), p_357957_.getCenter(), JUMP_TARGET_LINE_COLOR);
                                DebugRenderer.renderFilledBox(
                                    p_311387_,
                                    p_310722_,
                                    AABB.unitCubeFromLowerCorner(Vec3.atLowerCornerOf(p_357957_)).move(-p_312623_, -p_310151_, -p_312438_),
                                    1.0F,
                                    0.0F,
                                    0.0F,
                                    1.0F
