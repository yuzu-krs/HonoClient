...
public class ItemColors {
    ...
    public static ItemColors createDefault(BlockColors p_92684_) {
        ...
        itemcolors.register(
            (p_357659_, p_357660_) -> p_357660_ > 0 ? -1 : ARGB.opaque(p_357659_.getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).getColor()),
            Items.POTION,
            Items.SPLASH_POTION,
        ...
        for (SpawnEggItem spawneggitem : SpawnEggItem.eggs()) {
            itemcolors.register((p_357657_, p_357658_) -> ARGB.opaque(spawneggitem.getColor(p_357658_)), spawneggitem);
        }
