...
public abstract class AbstractScrollWidget extends AbstractWidget {
    ...
    protected void renderBorder(GuiGraphics p_289776_, int p_289792_, int p_289795_, int p_289775_, int p_289762_) {
        ...
        p_289776_.blitSprite(RenderType::guiTextured, resourcelocation, p_289792_, p_289795_, p_289775_, p_289762_);
    }
    ...
    private void renderScrollBar(GuiGraphics p_282305_) {
        ...
        p_282305_.blitSprite(RenderType::guiTextured, SCROLLER_SPRITE, j, k, 8, i);
    }
