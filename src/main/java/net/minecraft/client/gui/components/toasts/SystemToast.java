...
public class SystemToast implements Toast {
    ...
    public void render(GuiGraphics p_281624_, Font p_368558_, long p_282762_) {
        ...
        if (i == 160 && this.messageLines.size() <= 1) {
            p_281624_.blitSprite(RenderType::guiTextured, BACKGROUND_SPRITE, 0, 0, i, this.height());
        } else {
            int j = this.height();
            int k = 28;
        ...
        if (this.messageLines.isEmpty()) {
            ...
            for (int j1 = 0; j1 < this.messageLines.size(); j1++) {
                p_281624_.drawString(p_368558_, this.messageLines.get(j1), 18, 18 + j1 * 12, -1, false);
            }
        }
    }
    ...
    private void renderBackgroundRow(GuiGraphics p_281840_, int p_281750_, int p_282371_, int p_283613_, int p_282880_) {
        ...
        p_281840_.blitSprite(RenderType::guiTextured, resourcelocation, 160, 32, 0, p_282371_, 0, p_283613_, i, p_282880_);

        for (int k = i; k < p_281750_ - j; k += 64) {
            p_281840_.blitSprite(RenderType::guiTextured, resourcelocation, 160, 32, 32, p_282371_, k, p_283613_, Math.min(64, p_281750_ - k - j), p_282880_);
        }

        p_281840_.blitSprite(RenderType::guiTextured, resourcelocation, 160, 32, 160 - j, p_282371_, p_281750_ - j, p_283613_, j, p_282880_);
    }
