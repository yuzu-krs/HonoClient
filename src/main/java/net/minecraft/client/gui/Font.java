...
public class Font {
    ...
    private int drawInternal(
        ...
        if (p_273531_) {
            this.renderText(p_273025_, p_273121_, p_272717_, p_273653_, true, p_273265_, p_273560_, p_273342_, p_273373_, p_273266_, p_362833_);
            matrix4f.translate(SHADOW_OFFSET);
        }

        p_273121_ = this.renderText(p_273025_, p_273121_, p_272717_, p_273653_, false, matrix4f, p_273560_, p_273342_, p_273373_, p_273266_, p_362833_);
    ...
    class StringRenderOutput implements FormattedCharSink {
        ...
        public StringRenderOutput(
            ...
            this.x = p_364376_;
            this.y = p_367232_;
            this.dropShadow = p_369620_;
            this.dimFactor = p_369620_ ? 0.25F : 1.0F;
            this.color = ARGB.scaleRGB(p_363543_, this.dimFactor);
        ...
        public boolean accept(int p_92967_, Style p_92968_, int p_92969_) {
            ...
            if (!(bakedglyph instanceof EmptyGlyph)) {
                ...
                this.glyphInstances.add(new BakedGlyph.GlyphInstance(this.x + f3, this.y + f3, i, bakedglyph, p_92968_, f2));
            }

            float f4 = this.dropShadow ? 1.0F : 0.0F;
            if (p_92968_.isStrikethrough()) {
                this.addEffect(
                    new BakedGlyph.Effect(f1 + f4, this.y + f4 + 4.5F, this.x + f4 + f, this.y + f4 + 4.5F - 1.0F, this.getOverTextEffectDepth(), i)
                );
            }

            if (p_92968_.isUnderlined()) {
                this.addEffect(
                    new BakedGlyph.Effect(f1 + f4, this.y + f4 + 9.0F, this.x + f4 + f, this.y + f4 + 9.0F - 1.0F, this.getOverTextEffectDepth(), i)
                );
            }
