...
public class AdvancementWidget {
    ...
    public void drawHover(GuiGraphics p_283068_, int p_281304_, int p_281253_, float p_281848_, int p_282097_, int p_281537_) {
        ...
        if (!this.description.isEmpty()) {
            if (flag1) {
                p_283068_.blitSprite(RenderType::guiTextured, TITLE_BOX_SPRITE, i1, l + 26 - j1, this.width, j1);
            } else {
                p_283068_.blitSprite(RenderType::guiTextured, TITLE_BOX_SPRITE, i1, l, this.width, j1);
            }
        }

        p_283068_.blitSprite(RenderType::guiTextured, advancementwidgettype.boxSprite(), 200, 26, 0, 0, i1, l, j, 26);
        p_283068_.blitSprite(RenderType::guiTextured, advancementwidgettype1.boxSprite(), 200, 26, 200 - k, 0, i1 + j, l, k, 26);
