...
public class MobBucketItem extends BucketItem {
    ...
    private void spawn(ServerLevel p_151142_, ItemStack p_151143_, BlockPos p_151144_) {
        Entity entity = this.type.create(p_151142_, EntityType.createDefaultStackConfig(p_151142_, p_151143_, null), p_151144_, EntitySpawnReason.BUCKET, true, false);
        ...
        if (entity != null) {
            p_151142_.addFreshEntityWithPassengers(entity);
        }
    }
