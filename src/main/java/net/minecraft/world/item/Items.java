...
public class Items {
    ...
    public static final Item DECORATED_POT = registerBlock(Blocks.DECORATED_POT, new Item.Properties().component(DataComponents.POT_DECORATIONS, PotDecorations.EMPTY));
    ...
    public static final Item FURNACE = registerBlock(Blocks.FURNACE, p_329226_ -> p_329226_.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item PALE_OAK_BOAT = registerItem(
        "pale_oak_boat", p_359496_ -> new BoatItem(EntityType.PALE_OAK_BOAT, p_359496_), new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.WINTER_DROP)
    );
    public static final Item PALE_OAK_CHEST_BOAT = registerItem(
        "pale_oak_chest_boat", p_359772_ -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, p_359772_), new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.WINTER_DROP)
    );
    ...
    public static final Item BUNDLE = registerItem(
        "bundle",
        p_359710_ -> new BundleItem(ResourceLocation.withDefaultNamespace("bundle_open_front"), ResourceLocation.withDefaultNamespace("bundle_open_back"), p_359710_),
    ...
    public static final Item WHITE_BUNDLE = registerItem(
        "white_bundle",
        p_359594_ -> new BundleItem(ResourceLocation.withDefaultNamespace("white_bundle_open_front"), ResourceLocation.withDefaultNamespace("white_bundle_open_back"), p_359594_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item ORANGE_BUNDLE = registerItem(
        "orange_bundle",
        p_359447_ -> new BundleItem(ResourceLocation.withDefaultNamespace("orange_bundle_open_front"), ResourceLocation.withDefaultNamespace("orange_bundle_open_back"), p_359447_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item MAGENTA_BUNDLE = registerItem(
        "magenta_bundle",
        p_359677_ -> new BundleItem(ResourceLocation.withDefaultNamespace("magenta_bundle_open_front"), ResourceLocation.withDefaultNamespace("magenta_bundle_open_back"), p_359677_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item LIGHT_BLUE_BUNDLE = registerItem(
        "light_blue_bundle",
        p_359725_ -> new BundleItem(
                ResourceLocation.withDefaultNamespace("light_blue_bundle_open_front"), ResourceLocation.withDefaultNamespace("light_blue_bundle_open_back"), p_359725_
            ),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item YELLOW_BUNDLE = registerItem(
        "yellow_bundle",
        p_359757_ -> new BundleItem(ResourceLocation.withDefaultNamespace("yellow_bundle_open_front"), ResourceLocation.withDefaultNamespace("yellow_bundle_open_back"), p_359757_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item LIME_BUNDLE = registerItem(
        "lime_bundle",
        p_359634_ -> new BundleItem(ResourceLocation.withDefaultNamespace("lime_bundle_open_front"), ResourceLocation.withDefaultNamespace("lime_bundle_open_back"), p_359634_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item PINK_BUNDLE = registerItem(
        "pink_bundle",
        p_359455_ -> new BundleItem(ResourceLocation.withDefaultNamespace("pink_bundle_open_front"), ResourceLocation.withDefaultNamespace("pink_bundle_open_back"), p_359455_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item GRAY_BUNDLE = registerItem(
        "gray_bundle",
        p_359426_ -> new BundleItem(ResourceLocation.withDefaultNamespace("gray_bundle_open_front"), ResourceLocation.withDefaultNamespace("gray_bundle_open_back"), p_359426_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item LIGHT_GRAY_BUNDLE = registerItem(
        "light_gray_bundle",
        p_359673_ -> new BundleItem(
                ResourceLocation.withDefaultNamespace("light_gray_bundle_open_front"), ResourceLocation.withDefaultNamespace("light_gray_bundle_open_back"), p_359673_
            ),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item CYAN_BUNDLE = registerItem(
        "cyan_bundle",
        p_359678_ -> new BundleItem(ResourceLocation.withDefaultNamespace("cyan_bundle_open_front"), ResourceLocation.withDefaultNamespace("cyan_bundle_open_back"), p_359678_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item PURPLE_BUNDLE = registerItem(
        "purple_bundle",
        p_359524_ -> new BundleItem(ResourceLocation.withDefaultNamespace("purple_bundle_open_front"), ResourceLocation.withDefaultNamespace("purple_bundle_open_back"), p_359524_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item BLUE_BUNDLE = registerItem(
        "blue_bundle",
        p_359707_ -> new BundleItem(ResourceLocation.withDefaultNamespace("blue_bundle_open_front"), ResourceLocation.withDefaultNamespace("blue_bundle_open_back"), p_359707_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item BROWN_BUNDLE = registerItem(
        "brown_bundle",
        p_359627_ -> new BundleItem(ResourceLocation.withDefaultNamespace("brown_bundle_open_front"), ResourceLocation.withDefaultNamespace("brown_bundle_open_back"), p_359627_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item GREEN_BUNDLE = registerItem(
        "green_bundle",
        p_359416_ -> new BundleItem(ResourceLocation.withDefaultNamespace("green_bundle_open_front"), ResourceLocation.withDefaultNamespace("green_bundle_open_back"), p_359416_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item RED_BUNDLE = registerItem(
        "red_bundle",
        p_359435_ -> new BundleItem(ResourceLocation.withDefaultNamespace("red_bundle_open_front"), ResourceLocation.withDefaultNamespace("red_bundle_open_back"), p_359435_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    public static final Item BLACK_BUNDLE = registerItem(
        "black_bundle",
        p_359603_ -> new BundleItem(ResourceLocation.withDefaultNamespace("black_bundle_open_front"), ResourceLocation.withDefaultNamespace("black_bundle_open_back"), p_359603_),
        new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
    );
    ...
    public static final Item ARMADILLO_SPAWN_EGG = registerItem("armadillo_spawn_egg", p_359488_ -> new SpawnEggItem(EntityType.ARMADILLO, 11366765, 8538184, p_359488_));
    public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", p_359599_ -> new SpawnEggItem(EntityType.ALLAY, 56063, 44543, p_359599_));
    public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", p_359741_ -> new SpawnEggItem(EntityType.AXOLOTL, 16499171, 10890612, p_359741_));
    public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", p_359517_ -> new SpawnEggItem(EntityType.BAT, 4996656, 986895, p_359517_));
    public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", p_359637_ -> new SpawnEggItem(EntityType.BEE, 15582019, 4400155, p_359637_));
    public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", p_359642_ -> new SpawnEggItem(EntityType.BLAZE, 16167425, 16775294, p_359642_));
    public static final Item BOGGED_SPAWN_EGG = registerItem("bogged_spawn_egg", p_359716_ -> new SpawnEggItem(EntityType.BOGGED, 9084018, 3231003, p_359716_));
    public static final Item BREEZE_SPAWN_EGG = registerItem("breeze_spawn_egg", p_359478_ -> new SpawnEggItem(EntityType.BREEZE, 11506911, 9529055, p_359478_));
    public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", p_359679_ -> new SpawnEggItem(EntityType.CAT, 15714446, 9794134, p_359679_));
    public static final Item CAMEL_SPAWN_EGG = registerItem("camel_spawn_egg", p_359626_ -> new SpawnEggItem(EntityType.CAMEL, 16565097, 13341495, p_359626_));
    public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", p_359540_ -> new SpawnEggItem(EntityType.CAVE_SPIDER, 803406, 11013646, p_359540_));
    public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", p_359487_ -> new SpawnEggItem(EntityType.CHICKEN, 10592673, 16711680, p_359487_));
    public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", p_359464_ -> new SpawnEggItem(EntityType.COD, 12691306, 15058059, p_359464_));
    public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", p_359692_ -> new SpawnEggItem(EntityType.COW, 4470310, 10592673, p_359692_));
    public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", p_359424_ -> new SpawnEggItem(EntityType.CREEPER, 894731, 0, p_359424_));
    public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", p_359683_ -> new SpawnEggItem(EntityType.DOLPHIN, 2243405, 16382457, p_359683_));
    public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", p_359787_ -> new SpawnEggItem(EntityType.DONKEY, 5457209, 8811878, p_359787_));
    public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", p_359504_ -> new SpawnEggItem(EntityType.DROWNED, 9433559, 7969893, p_359504_));
    public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem("elder_guardian_spawn_egg", p_359708_ -> new SpawnEggItem(EntityType.ELDER_GUARDIAN, 13552826, 7632531, p_359708_));
    public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem("ender_dragon_spawn_egg", p_359613_ -> new SpawnEggItem(EntityType.ENDER_DRAGON, 1842204, 14711290, p_359613_));
    public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", p_359423_ -> new SpawnEggItem(EntityType.ENDERMAN, 1447446, 0, p_359423_));
    public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", p_359766_ -> new SpawnEggItem(EntityType.ENDERMITE, 1447446, 7237230, p_359766_));
    public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", p_359611_ -> new SpawnEggItem(EntityType.EVOKER, 9804699, 1973274, p_359611_));
    public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", p_359616_ -> new SpawnEggItem(EntityType.FOX, 14005919, 13396256, p_359616_));
    public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", p_359461_ -> new SpawnEggItem(EntityType.FROG, 13661252, 16762748, p_359461_));
    public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", p_359737_ -> new SpawnEggItem(EntityType.GHAST, 16382457, 12369084, p_359737_));
    public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", p_359649_ -> new SpawnEggItem(EntityType.GLOW_SQUID, 611926, 8778172, p_359649_));
    public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", p_359684_ -> new SpawnEggItem(EntityType.GOAT, 10851452, 5589310, p_359684_));
    public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", p_359717_ -> new SpawnEggItem(EntityType.GUARDIAN, 5931634, 15826224, p_359717_));
    public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", p_359580_ -> new SpawnEggItem(EntityType.HOGLIN, 13004373, 6251620, p_359580_));
    public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", p_359656_ -> new SpawnEggItem(EntityType.HORSE, 12623485, 15656192, p_359656_));
    public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", p_359511_ -> new SpawnEggItem(EntityType.HUSK, 7958625, 15125652, p_359511_));
    public static final Item IRON_GOLEM_SPAWN_EGG = registerItem("iron_golem_spawn_egg", p_359492_ -> new SpawnEggItem(EntityType.IRON_GOLEM, 14405058, 7643954, p_359492_));
    public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", p_359589_ -> new SpawnEggItem(EntityType.LLAMA, 12623485, 10051392, p_359589_));
    public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", p_359779_ -> new SpawnEggItem(EntityType.MAGMA_CUBE, 3407872, 16579584, p_359779_));
    public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", p_359565_ -> new SpawnEggItem(EntityType.MOOSHROOM, 10489616, 12040119, p_359565_));
    public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", p_359451_ -> new SpawnEggItem(EntityType.MULE, 1769984, 5321501, p_359451_));
    public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", p_359685_ -> new SpawnEggItem(EntityType.OCELOT, 15720061, 5653556, p_359685_));
    public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", p_359665_ -> new SpawnEggItem(EntityType.PANDA, 15198183, 1776418, p_359665_));
    public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", p_359645_ -> new SpawnEggItem(EntityType.PARROT, 894731, 16711680, p_359645_));
    public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", p_359624_ -> new SpawnEggItem(EntityType.PHANTOM, 4411786, 8978176, p_359624_));
    public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", p_359584_ -> new SpawnEggItem(EntityType.PIG, 15771042, 14377823, p_359584_));
    public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", p_359484_ -> new SpawnEggItem(EntityType.PIGLIN, 10051392, 16380836, p_359484_));
    public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem("piglin_brute_spawn_egg", p_359483_ -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, 5843472, 16380836, p_359483_));
    public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", p_359612_ -> new SpawnEggItem(EntityType.PILLAGER, 5451574, 9804699, p_359612_));
    public static final Item POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", p_359523_ -> new SpawnEggItem(EntityType.POLAR_BEAR, 15658718, 14014157, p_359523_));
    public static final Item PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", p_359577_ -> new SpawnEggItem(EntityType.PUFFERFISH, 16167425, 3654642, p_359577_));
    public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", p_359620_ -> new SpawnEggItem(EntityType.RABBIT, 10051392, 7555121, p_359620_));
    public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", p_359522_ -> new SpawnEggItem(EntityType.RAVAGER, 7697520, 5984329, p_359522_));
    public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", p_359479_ -> new SpawnEggItem(EntityType.SALMON, 10489616, 951412, p_359479_));
    public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", p_359730_ -> new SpawnEggItem(EntityType.SHEEP, 15198183, 16758197, p_359730_));
    public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", p_359542_ -> new SpawnEggItem(EntityType.SHULKER, 9725844, 5060690, p_359542_));
    public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", p_359586_ -> new SpawnEggItem(EntityType.SILVERFISH, 7237230, 3158064, p_359586_));
    public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", p_359738_ -> new SpawnEggItem(EntityType.SKELETON, 12698049, 4802889, p_359738_));
    public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem("skeleton_horse_spawn_egg", p_359420_ -> new SpawnEggItem(EntityType.SKELETON_HORSE, 6842447, 15066584, p_359420_));
    public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", p_359771_ -> new SpawnEggItem(EntityType.SLIME, 5349438, 8306542, p_359771_));
    public static final Item SNIFFER_SPAWN_EGG = registerItem("sniffer_spawn_egg", p_359775_ -> new SpawnEggItem(EntityType.SNIFFER, 8855049, 2468720, p_359775_));
    public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem("snow_golem_spawn_egg", p_359651_ -> new SpawnEggItem(EntityType.SNOW_GOLEM, 14283506, 8496292, p_359651_));
    public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", p_359465_ -> new SpawnEggItem(EntityType.SPIDER, 3419431, 11013646, p_359465_));
    public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", p_359601_ -> new SpawnEggItem(EntityType.SQUID, 2243405, 7375001, p_359601_));
    public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", p_359505_ -> new SpawnEggItem(EntityType.STRAY, 6387319, 14543594, p_359505_));
    public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", p_359755_ -> new SpawnEggItem(EntityType.STRIDER, 10236982, 5065037, p_359755_));
    public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", p_359429_ -> new SpawnEggItem(EntityType.TADPOLE, 7164733, 1444352, p_359429_));
    public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem("trader_llama_spawn_egg", p_359566_ -> new SpawnEggItem(EntityType.TRADER_LLAMA, 15377456, 4547222, p_359566_));
    public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem("tropical_fish_spawn_egg", p_359454_ -> new SpawnEggItem(EntityType.TROPICAL_FISH, 15690005, 16775663, p_359454_));
    public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", p_359457_ -> new SpawnEggItem(EntityType.TURTLE, 15198183, 44975, p_359457_));
    public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", p_359500_ -> new SpawnEggItem(EntityType.VEX, 8032420, 15265265, p_359500_));
    public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", p_359745_ -> new SpawnEggItem(EntityType.VILLAGER, 5651507, 12422002, p_359745_));
    public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", p_359733_ -> new SpawnEggItem(EntityType.VINDICATOR, 9804699, 2580065, p_359733_));
    public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem(
        "wandering_trader_spawn_egg", p_359618_ -> new SpawnEggItem(EntityType.WANDERING_TRADER, 4547222, 15377456, p_359618_)
    );
    public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", p_359686_ -> new SpawnEggItem(EntityType.WARDEN, 1001033, 3790560, p_359686_));
    public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", p_359629_ -> new SpawnEggItem(EntityType.WITCH, 3407872, 5349438, p_359629_));
    public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", p_359583_ -> new SpawnEggItem(EntityType.WITHER, 1315860, 5075616, p_359583_));
    public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem("wither_skeleton_spawn_egg", p_359608_ -> new SpawnEggItem(EntityType.WITHER_SKELETON, 1315860, 4672845, p_359608_));
    public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", p_359456_ -> new SpawnEggItem(EntityType.WOLF, 14144467, 13545366, p_359456_));
    public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", p_359421_ -> new SpawnEggItem(EntityType.ZOGLIN, 13004373, 15132390, p_359421_));
    public static final Item CREAKING_SPAWN_EGG = registerItem("creaking_spawn_egg", p_359529_ -> new SpawnEggItem(EntityType.CREAKING, 6250335, 16545810, p_359529_));
    public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", p_359482_ -> new SpawnEggItem(EntityType.ZOMBIE, 44975, 7969893, p_359482_));
    public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem("zombie_horse_spawn_egg", p_359445_ -> new SpawnEggItem(EntityType.ZOMBIE_HORSE, 3232308, 9945732, p_359445_));
    public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem("zombie_villager_spawn_egg", p_359430_ -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, 5651507, 7969893, p_359430_));
    public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem(
        "zombified_piglin_spawn_egg", p_359759_ -> new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, 15373203, 5009705, p_359759_)
    );
    ...
    public static final Item BARREL = registerBlock(Blocks.BARREL, p_334615_ -> p_334615_.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SMOKER = registerBlock(Blocks.SMOKER, p_334900_ -> p_334900_.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLAST_FURNACE = registerBlock(Blocks.BLAST_FURNACE, p_332318_ -> p_332318_.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
