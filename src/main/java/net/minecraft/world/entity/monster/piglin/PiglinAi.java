...
public class PiglinAi {
    ...
    private static void initIdleActivity(Brain<Piglin> p_34892_) {
        p_34892_.addActivity(
            ...
            ImmutableList.of(
                ...
                StartAttacking.<Piglin>create((p_359286_, p_359287_) -> p_359287_.isAdult(), PiglinAi::findNearestValidAttackTarget),
    ...
    private static void initCelebrateActivity(Brain<Piglin> p_34921_) {
        p_34921_.addActivityAndRemoveMemoryWhenStopped(
            ...
            ImmutableList.of(
                avoidRepellent(),
                SetEntityLookTarget.create(PiglinAi::isPlayerHoldingLovedItem, 14.0F),
                StartAttacking.<Piglin>create((p_359290_, p_359291_) -> p_359291_.isAdult(), PiglinAi::findNearestValidAttackTarget),
    ...
    protected static void wasHurtBy(ServerLevel p_361749_, Piglin p_34838_, LivingEntity p_34839_) {
        if (!(p_34839_ instanceof Piglin)) {
            ...
            getAvoidTarget(p_34838_).ifPresent(p_359279_ -> {
                if (p_359279_.getType() != p_34839_.getType()) {
    ...
    public static boolean isWearingSafeArmor(LivingEntity p_365495_) {
        for (ItemStack itemstack : p_365495_.getArmorAndBodyArmorSlots()) {
    ...
    private static BehaviorControl<LivingEntity> babySometimesRideBabyHoglin() {
        ...
        return CopyMemoryWithExpiry.create(
            p_359289_ -> p_359289_.isBaby() && setentitylooktargetsometimes$ticker.tickDownAndCheck(p_359289_.level().random),
    ...
    protected static void broadcastAngerTarget(ServerLevel p_368320_, AbstractPiglin p_366359_, LivingEntity p_364430_) {
        getAdultPiglins(p_366359_).forEach(p_359273_ -> {
            if (p_364430_.getType() != EntityType.HOGLIN || p_359273_.canHunt() && ((Hoglin)p_364430_).canBeHunted()) {
                setAngerTargetIfCloserThanCurrent(p_368320_, p_359273_, p_364430_);
            }
        });
    }
