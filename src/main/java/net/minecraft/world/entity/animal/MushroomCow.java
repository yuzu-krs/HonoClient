...
public class MushroomCow extends Cow implements Shearable, VariantHolder<MushroomCow.Variant> {
    ...
    public void shear(ServerLevel p_369641_, SoundSource p_28924_, ItemStack p_364876_) {
        ...
        this.convertTo(EntityType.COW, ConversionParams.single(this, false, false), p_359168_ -> {
            p_369641_.sendParticles(ParticleTypes.EXPLOSION, this.getX(), this.getY(0.5), this.getZ(), 1, 0.0, 0.0, 0.0, 0.0);
            this.dropFromShearingLootTable(p_369641_, BuiltInLootTables.SHEAR_MOOSHROOM, p_364876_, (p_359169_, p_359170_) -> {
                for (int i = 0; i < p_359170_.getCount(); i++) {
                    p_359169_.addFreshEntity(new ItemEntity(this.level(), this.getX(), this.getY(1.0), this.getZ(), p_359170_.copyWithCount(1)));
                }
            });
        });
    }
