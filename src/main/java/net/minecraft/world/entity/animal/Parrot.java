...
public class Parrot extends ShoulderRidingEntity implements VariantHolder<Parrot.Variant>, FlyingAnimal {
    ...
    static final Map<EntityType<?>, SoundEvent> MOB_SOUND_MAP = Util.make(Maps.newHashMap(), p_359171_ -> {
        p_359171_.put(EntityType.BLAZE, SoundEvents.PARROT_IMITATE_BLAZE);
        p_359171_.put(EntityType.BOGGED, SoundEvents.PARROT_IMITATE_BOGGED);
        p_359171_.put(EntityType.BREEZE, SoundEvents.PARROT_IMITATE_BREEZE);
        p_359171_.put(EntityType.CAVE_SPIDER, SoundEvents.PARROT_IMITATE_SPIDER);
        p_359171_.put(EntityType.CREEPER, SoundEvents.PARROT_IMITATE_CREEPER);
        p_359171_.put(EntityType.DROWNED, SoundEvents.PARROT_IMITATE_DROWNED);
        p_359171_.put(EntityType.ELDER_GUARDIAN, SoundEvents.PARROT_IMITATE_ELDER_GUARDIAN);
        p_359171_.put(EntityType.ENDER_DRAGON, SoundEvents.PARROT_IMITATE_ENDER_DRAGON);
        p_359171_.put(EntityType.ENDERMITE, SoundEvents.PARROT_IMITATE_ENDERMITE);
        p_359171_.put(EntityType.EVOKER, SoundEvents.PARROT_IMITATE_EVOKER);
        p_359171_.put(EntityType.GHAST, SoundEvents.PARROT_IMITATE_GHAST);
        p_359171_.put(EntityType.GUARDIAN, SoundEvents.PARROT_IMITATE_GUARDIAN);
        p_359171_.put(EntityType.HOGLIN, SoundEvents.PARROT_IMITATE_HOGLIN);
        p_359171_.put(EntityType.HUSK, SoundEvents.PARROT_IMITATE_HUSK);
        p_359171_.put(EntityType.ILLUSIONER, SoundEvents.PARROT_IMITATE_ILLUSIONER);
        p_359171_.put(EntityType.MAGMA_CUBE, SoundEvents.PARROT_IMITATE_MAGMA_CUBE);
        p_359171_.put(EntityType.PHANTOM, SoundEvents.PARROT_IMITATE_PHANTOM);
        p_359171_.put(EntityType.PIGLIN, SoundEvents.PARROT_IMITATE_PIGLIN);
        p_359171_.put(EntityType.PIGLIN_BRUTE, SoundEvents.PARROT_IMITATE_PIGLIN_BRUTE);
        p_359171_.put(EntityType.PILLAGER, SoundEvents.PARROT_IMITATE_PILLAGER);
        p_359171_.put(EntityType.RAVAGER, SoundEvents.PARROT_IMITATE_RAVAGER);
        p_359171_.put(EntityType.SHULKER, SoundEvents.PARROT_IMITATE_SHULKER);
        p_359171_.put(EntityType.SILVERFISH, SoundEvents.PARROT_IMITATE_SILVERFISH);
        p_359171_.put(EntityType.SKELETON, SoundEvents.PARROT_IMITATE_SKELETON);
        p_359171_.put(EntityType.SLIME, SoundEvents.PARROT_IMITATE_SLIME);
        p_359171_.put(EntityType.SPIDER, SoundEvents.PARROT_IMITATE_SPIDER);
        p_359171_.put(EntityType.STRAY, SoundEvents.PARROT_IMITATE_STRAY);
        p_359171_.put(EntityType.VEX, SoundEvents.PARROT_IMITATE_VEX);
        p_359171_.put(EntityType.VINDICATOR, SoundEvents.PARROT_IMITATE_VINDICATOR);
        p_359171_.put(EntityType.WARDEN, SoundEvents.PARROT_IMITATE_WARDEN);
        p_359171_.put(EntityType.WITCH, SoundEvents.PARROT_IMITATE_WITCH);
        p_359171_.put(EntityType.WITHER, SoundEvents.PARROT_IMITATE_WITHER);
        p_359171_.put(EntityType.WITHER_SKELETON, SoundEvents.PARROT_IMITATE_WITHER_SKELETON);
        p_359171_.put(EntityType.ZOGLIN, SoundEvents.PARROT_IMITATE_ZOGLIN);
        p_359171_.put(EntityType.CREAKING, SoundEvents.PARROT_IMITATE_CREAKING);
        p_359171_.put(EntityType.CREAKING_TRANSIENT, SoundEvents.PARROT_IMITATE_CREAKING);
        p_359171_.put(EntityType.ZOMBIE, SoundEvents.PARROT_IMITATE_ZOMBIE);
        p_359171_.put(EntityType.ZOMBIE_VILLAGER, SoundEvents.PARROT_IMITATE_ZOMBIE_VILLAGER);
    });
    public float flap;
