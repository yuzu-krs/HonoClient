...
public class Tadpole extends AbstractFish {
    ...
    private void ageUp() {
        if (this.level() instanceof ServerLevel serverlevel) {
            this.convertTo(EntityType.FROG, ConversionParams.single(this, false, false), p_359210_ -> {
                p_359210_.finalizeSpawn(serverlevel, this.level().getCurrentDifficultyAt(p_359210_.blockPosition()), EntitySpawnReason.CONVERSION, null);
                p_359210_.setPersistenceRequired();
                p_359210_.fudgePositionAfterSizeChange(this.getDimensions(this.getPose()));
