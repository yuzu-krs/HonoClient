...
public class MoveToSkySeeingSpot {
    public static OneShot<LivingEntity> create(float p_259860_) {
        return BehaviorBuilder.create(
            p_258543_ -> p_258543_.group(p_258543_.absent(MemoryModuleType.WALK_TARGET)).apply(p_258543_, p_258545_ -> (p_359013_, p_359014_, p_359015_) -> {
                        if (p_359013_.canSeeSky(p_359014_.blockPosition())) {
                            return false;
                        } else {
                            Optional<Vec3> optional = Optional.ofNullable(getOutdoorPosition(p_359013_, p_359014_));
