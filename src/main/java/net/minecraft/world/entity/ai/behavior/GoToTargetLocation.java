    ...
    public static <E extends Mob> OneShot<E> create(MemoryModuleType<BlockPos> p_259938_, int p_259740_, float p_259957_) {
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_358938_, p_358939_, p_358940_) -> {
                            BlockPos blockpos = p_259997_.get(p_259831_);
                            boolean flag = blockpos.closerThan(p_358939_.blockPosition(), (double)p_259740_);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_358939_, getNearbyPos(p_358939_, blockpos), p_259957_, p_259740_);
                            }
