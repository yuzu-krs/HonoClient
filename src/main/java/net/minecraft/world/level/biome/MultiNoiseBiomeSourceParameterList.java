    ...
    public static record Preset(ResourceLocation id, MultiNoiseBiomeSourceParameterList.Preset.SourceProvider provider) {
        ...
        public static final MultiNoiseBiomeSourceParameterList.Preset OVERWORLD = new MultiNoiseBiomeSourceParameterList.Preset(
            ResourceLocation.withDefaultNamespace("overworld"), new MultiNoiseBiomeSourceParameterList.Preset.SourceProvider() {
                ...
                public <T> Climate.ParameterList<T> apply(Function<ResourceKey<Biome>, T> p_275530_) {
                    return MultiNoiseBiomeSourceParameterList.Preset.generateOverworldBiomes(p_275530_, OverworldBiomeBuilder.Modifier.NONE);
                }
            }
        );
        public static final MultiNoiseBiomeSourceParameterList.Preset OVERWORLD_WINTER_DROP = new MultiNoiseBiomeSourceParameterList.Preset(
            ResourceLocation.withDefaultNamespace("overworld_winter_drop"), new MultiNoiseBiomeSourceParameterList.Preset.SourceProvider() {
                @Override
                public <T> Climate.ParameterList<T> apply(Function<ResourceKey<Biome>, T> p_366235_) {
                    return MultiNoiseBiomeSourceParameterList.Preset.generateOverworldBiomes(p_366235_, OverworldBiomeBuilder.Modifier.WINTER_DROP);
                }
            }
        );
        ...
        static <T> Climate.ParameterList<T> generateOverworldBiomes(Function<ResourceKey<Biome>, T> p_277826_, OverworldBiomeBuilder.Modifier p_366451_) {
            Builder<Pair<Climate.ParameterPoint, T>> builder = ImmutableList.builder();
            new OverworldBiomeBuilder(p_366451_).addBiomes(p_275579_ -> builder.add(p_275579_.mapSecond(p_277826_)));
