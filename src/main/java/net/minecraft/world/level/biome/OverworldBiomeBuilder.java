...
public final class OverworldBiomeBuilder {
    ...
    public OverworldBiomeBuilder(OverworldBiomeBuilder.Modifier p_369331_) {
        this.modifier = p_369331_;
    }
    ...
    private ResourceKey<Biome> pickPlateauBiome(int p_187234_, int p_187235_, Climate.Parameter p_187236_) {
        if (p_187236_.max() >= 0L) {
            ResourceKey<Biome> resourcekey = (this.modifier == OverworldBiomeBuilder.Modifier.WINTER_DROP ? this.PLATEAU_BIOMES_VARIANT_WINTER_DROP : this.PLATEAU_BIOMES_VARIANT)[p_187234_][p_187235_];
            if (resourcekey != null) {
                return resourcekey;
            }
        }
