...
public class MultiNoiseBiomeSourceParameterLists {
    ...
    public static void winterDrop(BootstrapContext<MultiNoiseBiomeSourceParameterList> p_367212_) {
        HolderGetter<Biome> holdergetter = p_367212_.lookup(Registries.BIOME);
        p_367212_.register(OVERWORLD, new MultiNoiseBiomeSourceParameterList(MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD_WINTER_DROP, holdergetter));
    }
