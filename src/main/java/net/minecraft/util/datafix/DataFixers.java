...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder p_14514_) {
        ...
        Schema schema226 = p_14514_.addSchema(4054, SAME_NAMESPACED);
        p_14514_.addFixer(new OminousBannerRarityFix(schema226));
        Schema schema227 = p_14514_.addSchema(4055, SAME_NAMESPACED);
        p_14514_.addFixer(new AttributeIdPrefixFix(schema227));
        Schema schema228 = p_14514_.addSchema(4057, SAME_NAMESPACED);
        p_14514_.addFixer(new CarvingStepRemoveFix(schema228));
        Schema schema229 = p_14514_.addSchema(4059, V4059::new);
        p_14514_.addFixer(new FoodToConsumableFix(schema229));
        Schema schema230 = p_14514_.addSchema(4061, SAME_NAMESPACED);
        p_14514_.addFixer(new TrialSpawnerConfigInRegistryFix(schema230));
        Schema schema231 = p_14514_.addSchema(4064, SAME_NAMESPACED);
        p_14514_.addFixer(new FireResistantToDamageResistantComponentFix(schema231));
        Schema schema232 = p_14514_.addSchema(4067, V4067::new);
        p_14514_.addFixer(new BoatSplitFix(schema232));
        p_14514_.addFixer(new FeatureFlagRemoveFix(schema232, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
        Schema schema233 = p_14514_.addSchema(4068, SAME_NAMESPACED);
        p_14514_.addFixer(new LockComponentPredicateFix(schema233));
        p_14514_.addFixer(new ContainerBlockEntityLockPredicateFix(schema233));
        Schema schema234 = p_14514_.addSchema(4070, V4070::new);
        p_14514_.addFixer(new AddNewChoices(schema234, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
        Schema schema235 = p_14514_.addSchema(4071, V4071::new);
        p_14514_.addFixer(new AddNewChoices(schema235, "Added Creaking", References.ENTITY));
        p_14514_.addFixer(new AddNewChoices(schema235, "Added Creaking Heart", References.BLOCK_ENTITY));
        Schema schema236 = p_14514_.addSchema(4081, SAME_NAMESPACED);
        p_14514_.addFixer(new EntitySalmonSizeFix(schema236));
    }
