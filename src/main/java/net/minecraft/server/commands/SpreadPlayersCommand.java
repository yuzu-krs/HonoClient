                                            ...
                                            Commands.argument("respectTeams", BoolArgumentType.bool())
                                                .then(
                                                    Commands.argument("targets", EntityArgument.entities())
                                                        .executes(
                                                            p_358631_ -> spreadPlayers(
                                                                    p_358631_.getSource(),
                                                                    Vec2Argument.getVec2(p_358631_, "center"),
                                                                    FloatArgumentType.getFloat(p_358631_, "spreadDistance"),
                                                                    FloatArgumentType.getFloat(p_358631_, "maxRange"),
                                                                    p_358631_.getSource().getLevel().getMaxY() + 1,
                                                                    BoolArgumentType.getBool(p_358631_, "respectTeams"),
                                                                    EntityArgument.getEntities(p_358631_, "targets")
                                                                )
                                                        )
                                                )
                                        )
