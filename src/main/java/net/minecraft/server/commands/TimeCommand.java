                    ...
                    Commands.literal("query")
                        ...
                        .then(
                            Commands.literal("gametime")
                                .executes(p_358641_ -> queryTime(p_358641_.getSource(), (int)(p_358641_.getSource().getLevel().getGameTime() % 2147483647L)))
                        )
                        .then(
                            Commands.literal("day")
                                .executes(
                                    p_358642_ -> queryTime(p_358642_.getSource(), (int)(p_358642_.getSource().getLevel().getDayTime() / 24000L % 2147483647L))
                                )
                        )
                )
        );
